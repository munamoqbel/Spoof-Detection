...
% persistent 2 Hz gate SPF_gate once every ticks_per_epoch ticks,
...
%
%   - SPF_gate itself: persistent sys/epoch, resetRequest
...
for epoch = 1:num_epochs
    ...
    spoofTel = SPF_gate(kfMeas, propTel, true, epoch == 1);
