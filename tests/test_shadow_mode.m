...
for k = 1:N
    ...
    tel = SPF_gate(kfMeas, propTel, true, k == 1);  % outputs ignored (shadow)
...
alignOK = true;
for k = 1:5
    tel = SPF_gate(kfMeas, propTel, false, false);
...
tel = SPF_gate(kfMeas, propTel, true, false);       % re-entry, no resetRequest
